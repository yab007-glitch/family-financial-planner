...
const WealthOptimizer = require('../utils/wealth-optimizer');
...
router.post('/marginal-rate', async (req, res) => {
  try {
...
router.post('/rrsp-impact', async (req, res) => {
  try {
...
router.post('/resp-cesg', async (req, res) => {
  try {
